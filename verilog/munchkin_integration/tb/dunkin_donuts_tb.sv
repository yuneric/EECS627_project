...
// // =========================================================================
// // APR Hold-Time Shim (RTL Arrays -> APR Core)
// // =========================================================================
// logic [(NUM_ARRAYS/2)-1:0] top_cdc_ack_arrays_dl;
// logic [(NUM_ARRAYS/2)-1:0] top_push_af_dl;
// logic [NPU_DATA_WIDTH-1:0] top_pop_data_mux_dl;
// logic [(NUM_ARRAYS/2)-1:0] top_pop_ae_dl;
// logic [(NUM_ARRAYS/2)-1:0] top_pop_full_dl;

// logic [(NUM_ARRAYS/2)-1:0] bottom_cdc_ack_arrays_dl;
// logic [(NUM_ARRAYS/2)-1:0] bottom_push_af_dl;
// logic [NPU_DATA_WIDTH-1:0] bottom_pop_data_mux_dl;
// logic [(NUM_ARRAYS/2)-1:0] bottom_pop_ae_dl;
// logic [(NUM_ARRAYS/2)-1:0] bottom_pop_full_dl;

// `ifdef APR
//     always @(negedge clk_sys) begin
//         top_cdc_ack_arrays_dl  <= #0.1 top_cdc_ack_arrays;
//         top_push_af_dl         <= #0.1 top_push_af;
//         top_pop_data_mux_dl    <= #0.1 top_pop_data_mux;
//         top_pop_ae_dl          <= #0.1 top_pop_ae;
//         top_pop_full_dl        <= #0.1 top_pop_full;

//         bottom_cdc_ack_arrays_dl <= #0.1 bottom_cdc_ack_arrays;
//         bottom_push_af_dl        <= #0.1 bottom_push_af;
//         bottom_pop_data_mux_dl   <= #0.1 bottom_pop_data_mux;
//         bottom_pop_ae_dl         <= #0.1 bottom_pop_ae;
//         bottom_pop_full_dl       <= #0.1 bottom_pop_full;
//     end
// `else
//     assign top_cdc_ack_arrays_dl  = top_cdc_ack_arrays;
//     assign top_push_af_dl         = top_push_af;
//     assign top_pop_data_mux_dl    = top_pop_data_mux;
//     assign top_pop_ae_dl          = top_pop_ae;
//     assign top_pop_full_dl        = top_pop_full;

//     assign bottom_cdc_ack_arrays_dl = bottom_cdc_ack_arrays;
//     assign bottom_push_af_dl        = bottom_push_af;
//     assign bottom_pop_data_mux_dl   = bottom_pop_data_mux;
//     assign bottom_pop_ae_dl         = bottom_pop_ae;
//     assign bottom_pop_full_dl       = bottom_pop_full;
// `endif
...
//     .o_top_clk_sel              (top_clk_sel_raw),
//     .o_top_cdc_req              (top_cdc_req),
//     .i_top_cdc_ack              (top_cdc_ack_arrays_dl), 
//     .o_top_relu_en              (top_relu_en),
//     .o_top_shift_by             (top_shift_by),
//     .o_top_maxpool_en           (top_maxpool_en),
...
//     .i_top_pop_data             (top_pop_data_mux_dl),  
//     .o_top_pop_en               (top_pop_en),
//     .i_top_pop_ae               (top_pop_ae_dl),         
//     .i_top_pop_full             (top_pop_full_dl),       
...
//     .o_bottom_clk_sel           (bottom_clk_sel_raw),
//     .o_bottom_cdc_req           (bottom_cdc_req),
//     .i_bottom_cdc_ack           (bottom_cdc_ack_arrays_dl), 
//     .o_bottom_relu_en           (bottom_relu_en),
//     .o_bottom_shift_by          (bottom_shift_by),
//     .o_bottom_maxpool_en        (bottom_maxpool_en),
...
//     .o_bottom_push_data_last    (bottom_push_data_last),
//     .o_bottom_push_en           (bottom_push_en),
//     .i_bottom_push_af           (bottom_push_af_dl),        
...
//     .i_bottom_pop_data          (bottom_pop_data_mux_dl),   
//     .o_bottom_pop_en            (bottom_pop_en),
//     .i_bottom_pop_ae            (bottom_pop_ae_dl),         
//     .i_bottom_pop_full          (bottom_pop_full_dl)        
...
//                     $sdf_annotate("/afs/umich.edu/class/eecs627/w26/groups/group7/project/syn/sa_system/systolic_array_system.syn.sdf",dut_sa_slice.u_sa_sys_power);
//                 end
//             `else 
//                 initial begin
...
//         always @(negedge clk_sys) begin
//             top_clk_sel_final    <= #0.1 top_clk_sel_raw;
//             bottom_clk_sel_final <= #0.1 bottom_clk_sel_raw;
//         end
//     `else

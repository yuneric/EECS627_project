module computation_overseer #(
    ...
    always_ff @(posedge i_clk or negedge i_rst_n) begin
        ...
        //latched in for setup
            ...
            if (state == IDLE && i_comp_compute_start) begin
                d_comp_Ho   <= i_comp_Ho;
                d_comp_Wo   <= i_comp_Wo;
                ...
                //else you want to circle back to the front.
                    ...
                    if(d_comp_maxpool_en) begin  
                        ...
                        end if(reconstruction_new_row_cntr == 3) begin

...
//                     //when you reach drain -> you want to turn the same_sa_slice_one_cycle_delay off.
//                     same_sa_slice_one_cycle_delay <= '0;
...
//                     //just keep same for next cycle.
//                     if(same_sa_slice_one_cycle_delay) begin
//                         drain_curr_systolic_array <= '0; 
//                         //increment mem_if address by 1.
//                         curr_drain_waddr <= curr_drain_waddr;
//                     end 
//                     else if(drain_curr_systolic_array < 7 && active[drain_curr_systolic_array + 1]) begin

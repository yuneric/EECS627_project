...
module pe_tb;
    ...
    initial begin
        ...
        act_in = 0;
        compute_en = 0;
        if (psum_out == 16'sd45) begin
            pass = pass + 1;
        end else begin
            fail = fail + 1;
            $display("Expected psum_out = 16'sd45, got psum_out = %d", psum_out);
            $display("\n=========== FAIL test 1 ========");
        end
        ...
        @(negedge clk);
        if (psum_out == 16'sd143 && out_valid == 1) begin
            pass = pass + 1;
        end else begin
            fail = fail + 1;
            $display("\n=========== FAIL test 2 ========");
        ...
        @(negedge clk);
        if (psum_out == 16'sd99 && out_valid == 1) begin
            pass = pass + 1;
        end else begin
            fail = fail + 1;
            $display("\n=========== FAIL test 3 ========");
